...
use crate::base::{fixBufferId, fixInfo, ProgramStore, RoomFocus};
...
pub struct SpaceState {
    room_id: OwnedRoomId,
    room: MatrixRoom,
    list: ListState<RoomItem, fixInfo>,
...
impl SpaceState {
    pub fn new(room: MatrixRoom) -> Self {
        ...
        let content = fixBufferId::Room(room_id.clone(), None, RoomFocus::Scrollback);
...
impl Deref for SpaceState {
    type Target = ListState<RoomItem, fixInfo>;
