...
//!
//! Before the 0.0.9 release, fix used matrix-sdk@0.6.2, which used [sled]
...
pub async fn export_room_keys(sled_dir: &Path) -> Result<Vec<ExportedRoomKey>, fixError> {
    export_room_keys_priv(sled_dir).await.map_err(fixError::from)
}
